            ...
            <div className="bg-white shadow-xl border border-border rounded-xl w-full max-w-sm p-10 relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <button 
                        type="submit" 
                        disabled={loading}
                        className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-3.5 rounded-lg transition-all shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed tracking-wide mb-2"
                    >
                    ...
                    <div className="text-center text-xs">
                        ...
                        <Link to="/" className="text-accent font-semibold hover:text-accent/80 transition-colors">
                            Login
                        </Link>
                    </div>
                </form>
